...
public class GameFolder
{
     ...
     */
    public static final GameFolder BASIC = new GameFolder("assets", "libs", "natives", "minecraft.jar", "addons");
    
    /**
     * The game folder for FlowUpdater (assets, libraries, natives, client.jar)
     */
    public static final GameFolder FLOW_UPDATER = new GameFolder("assets", "libraries", "natives", "client.jar", "addons");
     ...
     */
    public static final GameFolder FLOW_UPDATER_1_19_SUP = new GameFolder("assets", "libraries", ".", "client.jar", "addons");
    ...
    /**
     * The name of the folder containing the addons
     */
    private final String addonsFolder;
     ...
     * @param addonsFolder The name of the folder containing all the addons
     */
    public GameFolder(String assetsFolder, String libsFolder, String nativesFolder, String mainJar, String addonsFolder)
    {
    ...
    /**
     * Returns the name of the folder containing the addons
     *
     * @return The name of the addons folder
     */
